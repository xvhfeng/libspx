...
spx_memptr_add(const void *p, const i32_t offset) {
    return (void *) (((char *) p) + offset);
}

__SpxPrivate__ __SpxInline__ void *
spx_memptr_sub(const void *p, const i32_t offset) {
    return (void *) (((char *) p) - offset);
}

__SpxPrivate__ __SpxInline__ i32_t
spx_memptr_diff(const void *p1, const void *p2) {
 ...
 */
__SpxPrivate__ __SpxInline__ i32_t
spx_align(const i32_t off, const i32_t base) {
    return (((off) + ((base) -1)) & (~((base) -1)));
}

__SpxPrivate__ __SpxInline__ i32_t
spx_align_factor(const i32_t off, const i32_t base) {
    return (spx_align(off, base) / base);
}

__SpxPrivate__ __SpxInline__ i32_t
spx_sys_align(const i32_t off) {
    return spx_align(off, SpxBit);
}

__SpxPrivate__ __SpxInline__ i32_t
spx_sys_align_factor(const i32_t off) {
 ...
 */
__SpxPrivate__ __SpxInline__ i32_t
spx_bit_align(const i32_t bitcount) {
 ...
 */
__SpxPrivate__ __SpxInline__ i32_t
spx_bit_to_byte(const i32_t bitcount) {
 ...
 */
__SpxPrivate__ __SpxInline__ i32_t
spx_bit_to_byte_align(const i32_t bitcount) {
...
#define spx_retry(e) (EAGAIN == e || EWOULDBLOCK == e || EINTR == e)
